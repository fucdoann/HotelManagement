export default function FailPopUp({ main_mess, mess, setFailPop }){
    return(
        <div className="dark:bg-dar z-50 bg-white  fixed left-1/2 top-[50%] transform -translate-x-1/2 -translate-y-16 rounded shadow-md transition-transform duration-500 ">
      <div className="container">
        <div className="border-l-yellow-900 bg-white shadow-md dark:bg-dark-2 flex max-w-[655px] items-center rounded-md border-l-[6px] bg-white p-5 pl-6">
          <div className="bg-yellow-900 mr-5 flex h-[36px] w-full max-w-[36px] items-center justify-center rounded-full">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
