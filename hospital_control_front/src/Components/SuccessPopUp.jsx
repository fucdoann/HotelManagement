export default function SuccessPopUp({props}) {    
    return (
      ...
      <div className="container">
        <div style={{'borderColor': 'rgb(34 173 92 / 0.5)'}} className="border-green bg-[#DAF8E6] flex w-full rounded-lg border-l-[6px] px-7 py-8 md:p-9">
          <div className="bg-green-600 mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
