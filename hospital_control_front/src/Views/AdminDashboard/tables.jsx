...
export function Tables() {
  ...
  return (
    <>
      {showDelete && <ConfirmDelete setShowDelete={setShowDelete} deleteHotel={deleteHotel} deleteId={deleteId} type={"Khách sạn"} />}
            ...
            <div className="overflow-x-auto">
              <div className="inline-block min-w-full shadow-md rounded-lg overflow-hidden">
                <table className="min-w-full leading-normal bg-white border border-gray-200">
                  ...
                  <tbody>
                    {listHotel.length > 0 &&
                      listHotel.slice(index * 10, index * 10 + 10).map((item, i) => (
